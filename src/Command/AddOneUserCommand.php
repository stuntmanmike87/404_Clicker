...
final class AddOneUserCommand extends Command
{
    ...
    {
        $this
            ->addArgument('email', InputArgument::REQUIRED, self::EMAIL_ARG)
            ->addArgument('plainPassword', InputArgument::REQUIRED, self::PW_ARG)
            ->addArgument('role', InputArgument::REQUIRED, self::ROLE_ARG)
            ->addArgument('isVerified', InputArgument::REQUIRED, self::ISV_ARG)
        ;
    }
