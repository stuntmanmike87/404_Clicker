...
final class ResetPasswordController extends AbstractController
{
     ...
     *
     * Fonction qui traite la récupération de l'adresse e-mail de l'utilisateur,
    ...
    public function reset(
        ...
        ?string $token = null
    ): Response {// Your function is too long. Currently using 49 lines.
    ...
    /**
     * Fonction privée qui traite l'envoi d'une adresse e-mail de réinitialisation de mot de passe.
     */
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())->htmlTemplate('reset_password/email.html.twig');
