...
trait AcceptanceTesterActions
{
     ...
     * If Codeception commands are not enough,
     * use [Guzzle HTTP Client](http://guzzlephp.org/) methods directly
     *
     * Example:
     *
     * ``` php
     ...
     * If Codeception lacks important Guzzle Client methods,
     * implement them and submit patches.
     *
     ...
     * If a fuzzy locator is given, the page will be searched
     * for a button, link, or image matching the locator string.
     * For buttons, the "value" attribute, "name" attribute,
     * and inner text are searched.
     * For links, the link text is searched.
     * For images, the "alt" attribute and inner text
     * of any parent links are searched.
     *
     * The second parameter is a context (CSS or XPath locator)
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Checks that the current page contains
     ...
     * ```
     *
     * Note that the search is done after stripping
     * all HTML tags from the body,
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Checks that the current page doesn't contain
     * the text specified (case insensitive).
     ...
     * Give a full URL as the second parameter
     * to match links with that exact URL.
     *
     * ``` php
     * <?php
     ...
     * If the second parameter is given, only links
     * with a matching "href" attribute will be checked.
     *
     * ``` php
     * <?php
     ...
     * against the current URI and returns the first match.
     ...
     * For fuzzy locators, fields are matched by label text,
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Checks if the array of form parameters (name => value)
     * are set on the form matched with the
     * passed selector.
     *
     * ``` php
     * <?php
     ...
     * ```
     *
     * For multi-select elements, or to check values
     * of multiple elements with the same name, an
     * array may be passed:
     *
     * ``` php
     * <?php
     ...
     *
     * Checks if the array of form parameters (name => value)
     * are not set on the form matched with
     * the passed selector.
     *
     * ``` php
     * <?php
     ...
     * ```
     *
     * To check that an element hasn't been assigned
     * any one of many values, an array can be passed
     * as the value:
     *
     * ``` php
     * <?php
     ...
     * ```
     *
     * To check that an element hasn't been assigned any one of many values,
     ...
     * differences:
     *
     * Only field *names* may be used,
     * not CSS/XPath selectors nor field labels
     * If a field is sent to this function
     * that does *not* exist on the page,
     * it will silently be added to the HTTP request.
     * This is helpful for testing
     * some types of forms, but be aware that you
     * will *not* get an exception
     * like you would if you called `fillField()` or `selectOption()` with
     * a missing field.
     *
     * Fields that are not provided will be filled
     * by their values from the page,
     ...
     * $I->selectOption('Which OS do you use?', array('value' => 'windows'));
     ...
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     * Ticks a checkbox. For radio buttons,
     * use the `selectOption` method instead.
     *
     * ``` php
     * <?php
     * $I->checkOption('#agree');
     ...
     * data directory to the given file upload field.
     *
     * ``` php
     * <?php
     ...
     * Example:
     *
     * Imagine that by clicking checkbox you trigger
     ...
     * '/updateSettings', array('notifications' => true)
     * ); // POST
     ...
     * `path`, `expires`, `secure` in array passed as last argument.
     *
     * ``` php
     * <?php
     ...
     * You can set additional cookie params like `domain`,
     * `path` in array passed as last argument.
     *
     ...
     * You can set additional cookie params like `domain`,
     * `path` as array passed in last argument.
     *
     * ``` php
     * <?php
    ...
    public function cantSeeResponseCodeIs($code) {
        return $this->getScenario()->runStep(
            new \Codeception\Step\ConditionalAssertion(
                'dontSeeResponseCodeIs', func_get_args()
            )
        );
    }
