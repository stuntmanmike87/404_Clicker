...
final class MailerCest
{
    ...
    public function grabLastSentEmail(FunctionalTester $I): void
    {
        $I->amOnPage('/register');
        $I->stopFollowingRedirects();
    ...
    public function grabSentEmails(FunctionalTester $I): void
    {
        $I->amOnPage('/register');
        $I->stopFollowingRedirects();
    ...
    public function seeEmailIsSent(FunctionalTester $I): void
    {
        $I->amOnPage('/register');
        $I->stopFollowingRedirects();
