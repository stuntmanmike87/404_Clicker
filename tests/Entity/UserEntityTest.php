...
{//final class UserEntityTest extends TestCase
    private const EMAIL_CONSTRAINT_MESSAGE =
        'L\'e-mail {{value}} n\'est pas valide.';

    private const NOT_BLANK_CONSTRAINT_MESSAGE =
    ...
    private const PASSWORD_REGEX_CONSTRAINT_MESSAGE =
        ...
        de 12 caractères dont au minimum : 
        1 lettre minuscule, 1 lettre majuscule, 1 chiffre, 
        1 caractère spécial (dans un ordre aléatoire).';
