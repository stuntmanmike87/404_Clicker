...
{//final class LevelTest extends TestCase
    ...
    private const PATH_CONSTRAINT_MESSAGE =
        'Le fichier est introuvable à l\'emplacement spécifié';

    //private const INVALID_DIRECTORY_PATH_MESSAGE =
    //'Le chemin spécifié est invalide';
